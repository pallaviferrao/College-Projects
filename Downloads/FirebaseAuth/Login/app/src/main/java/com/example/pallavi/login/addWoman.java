 ...
 */
public class addWoman extends AppCompatActivity {
    ...
    /*private void selectImage() {
        final CharSequence[] items = {"Take Photo", "Choose from Library",
                "Cancel"};
        AlertDialog.Builder builder = new AlertDialog.Builder(addWoman.this);
        builder.setTitle("Add Photo!");
        builder.setItems(items, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int item) {
                boolean result = Utility.checkPermission(addWoman.this);
        ...
        switch (requestCode) {
            case Utility.MY_PERMISSIONS_REQUEST_READ_EXTERNAL_STORAGE:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(addWoman.this, "Permission denied", Toast.LENGTH_SHORT).show();
                }
                break;
        }
    }*//*
    ...
    private boolean validate()
    {
        ...
        if(flag==0)
        {
            Toast.makeText(addWoman.this, "Image required", Toast.LENGTH_SHORT).show();
            valid=false;
        }
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                if(downloadUrl!=null)
                {
                    ...
                    //notify adapter
                   // LoginActivity.gridAdapter.notifyDataSetChanged();
    ...
    /*
                    ...
                    Intent i=new Intent(addWoman.this,LoginActivity.class);
                    i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    startActivity(i);
                    Toast.makeText(addWoman.this, "book added successfully",
